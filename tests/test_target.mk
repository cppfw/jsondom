ifeq ($(os),windows)
    ...
    this_test_cmd := (cd $(d) && cmd //C 'set PATH=../../src/out/$(c);../../harness/out/$(c);%PATH% && out\$(c)\$$(notdir $$^)')
else ifeq ($(os),macosx)
...
ifeq ($(os),windows)
    # to avoid /C converted to C:\ need to escape it as //C
    this_gdb_cmd := (cd $(d) && cmd //C 'set PATH=../../src/out/$(c);../../harness/out/$(c);%PATH% && gdb out\$(c)\$$(notdir $$^)')
else ifeq ($(os),macosx)
